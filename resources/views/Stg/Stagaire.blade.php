...
<div id="container">
    <div id="FiliereGrid" >
                ...
                <h1 id="" style="margin-right:auto;">Stagiaires</h1>
                
                <div id="AbsgridItem">
                    <a href="{{route('Stg.create')}}" id='btn_danger'>Ajouter</a>
                    <a href="{{ route('export-Stagiaires') }}" id='btn_outline_danger'>Exporter</a>
                </div>
                
                <div id="AbsgridItem">
                    <form id="searchForm" action="{{ route('Stg.index') }}" method="GET">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span>
                            <a href="{{route('Stg.show',$Stg->idStg)}}">
                        ...
                        <span>
                            <a href="{{route('Stg.edit',$Stg->idStg)}}">
                        ...
                        <span>
                            <form action="{{route('Stg.destroy',$Stg->idStg)}}" method="POST" @style('display:inline')>
                                @csrf
                                @method('DELETE')
